<!-- skill-id: ecc-network-interface-health -->
<!-- source-path: ecc/network-interface-health -->
<!-- source-file: C:/Users/MDES-DEV-NB/.claude/skills/ecc/network-interface-health/SKILL.md -->
<!-- runtime: claude -->
