<!-- skill-id: ecc-foundation-models-on-device -->
<!-- source-path: ecc/foundation-models-on-device -->
<!-- source-file: C:/Users/MDES-DEV-NB/.claude/skills/ecc/foundation-models-on-device/SKILL.md -->
<!-- runtime: claude -->
