<!-- skill-id: ecc-production-scheduling -->
<!-- source-path: ecc/production-scheduling -->
<!-- source-file: C:/Users/MDES-DEV-NB/.claude/skills/ecc/production-scheduling/SKILL.md -->
<!-- runtime: claude -->
