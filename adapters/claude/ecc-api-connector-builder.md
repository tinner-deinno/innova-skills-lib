<!-- skill-id: ecc-api-connector-builder -->
<!-- source-path: ecc/api-connector-builder -->
<!-- source-file: C:/Users/MDES-DEV-NB/.claude/skills/ecc/api-connector-builder/SKILL.md -->
<!-- runtime: claude -->
