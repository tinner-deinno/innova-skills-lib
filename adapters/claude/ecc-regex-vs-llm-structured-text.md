<!-- skill-id: ecc-regex-vs-llm-structured-text -->
<!-- source-path: ecc/regex-vs-llm-structured-text -->
<!-- source-file: C:/Users/MDES-DEV-NB/.claude/skills/ecc/regex-vs-llm-structured-text/SKILL.md -->
<!-- runtime: claude -->
