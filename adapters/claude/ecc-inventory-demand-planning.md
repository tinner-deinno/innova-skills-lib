<!-- skill-id: ecc-inventory-demand-planning -->
<!-- source-path: ecc/inventory-demand-planning -->
<!-- source-file: C:/Users/MDES-DEV-NB/.claude/skills/ecc/inventory-demand-planning/SKILL.md -->
<!-- runtime: claude -->
