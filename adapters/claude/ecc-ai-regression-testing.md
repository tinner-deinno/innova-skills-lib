<!-- skill-id: ecc-ai-regression-testing -->
<!-- source-path: ecc/ai-regression-testing -->
<!-- source-file: C:/Users/MDES-DEV-NB/.claude/skills/ecc/ai-regression-testing/SKILL.md -->
<!-- runtime: claude -->
