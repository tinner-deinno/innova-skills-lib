<!-- skill-id: ecc-homelab-network-setup -->
<!-- source-path: ecc/homelab-network-setup -->
<!-- source-file: C:/Users/MDES-DEV-NB/.claude/skills/ecc/homelab-network-setup/SKILL.md -->
<!-- runtime: claude -->
