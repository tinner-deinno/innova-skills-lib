<!-- skill-id: ecc-ralphinho-rfc-pipeline -->
<!-- source-path: ecc/ralphinho-rfc-pipeline -->
<!-- source-file: C:/Users/MDES-DEV-NB/.claude/skills/ecc/ralphinho-rfc-pipeline/SKILL.md -->
<!-- runtime: claude -->
