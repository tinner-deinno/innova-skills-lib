<!-- skill-id: ecc-network-bgp-diagnostics -->
<!-- source-path: ecc/network-bgp-diagnostics -->
<!-- source-file: C:/Users/MDES-DEV-NB/.claude/skills/ecc/network-bgp-diagnostics/SKILL.md -->
<!-- runtime: claude -->
