<!-- skill-id: ecc-unified-notifications-ops -->
<!-- source-path: ecc/unified-notifications-ops -->
<!-- source-file: C:/Users/MDES-DEV-NB/.claude/skills/ecc/unified-notifications-ops/SKILL.md -->
<!-- runtime: claude -->
