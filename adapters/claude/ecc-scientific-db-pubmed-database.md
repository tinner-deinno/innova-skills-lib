<!-- skill-id: ecc-scientific-db-pubmed-database -->
<!-- source-path: ecc/scientific-db-pubmed-database -->
<!-- source-file: C:/Users/MDES-DEV-NB/.claude/skills/ecc/scientific-db-pubmed-database/SKILL.md -->
<!-- runtime: claude -->
