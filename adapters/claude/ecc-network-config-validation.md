<!-- skill-id: ecc-network-config-validation -->
<!-- source-path: ecc/network-config-validation -->
<!-- source-file: C:/Users/MDES-DEV-NB/.claude/skills/ecc/network-config-validation/SKILL.md -->
<!-- runtime: claude -->
