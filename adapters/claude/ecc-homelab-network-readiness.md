<!-- skill-id: ecc-homelab-network-readiness -->
<!-- source-path: ecc/homelab-network-readiness -->
<!-- source-file: C:/Users/MDES-DEV-NB/.claude/skills/ecc/homelab-network-readiness/SKILL.md -->
<!-- runtime: claude -->
