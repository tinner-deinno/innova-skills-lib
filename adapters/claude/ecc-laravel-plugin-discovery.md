<!-- skill-id: ecc-laravel-plugin-discovery -->
<!-- source-path: ecc/laravel-plugin-discovery -->
<!-- source-file: C:/Users/MDES-DEV-NB/.claude/skills/ecc/laravel-plugin-discovery/SKILL.md -->
<!-- runtime: claude -->
