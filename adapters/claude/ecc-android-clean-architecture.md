<!-- skill-id: ecc-android-clean-architecture -->
<!-- source-path: ecc/android-clean-architecture -->
<!-- source-file: C:/Users/MDES-DEV-NB/.claude/skills/ecc/android-clean-architecture/SKILL.md -->
<!-- runtime: claude -->
