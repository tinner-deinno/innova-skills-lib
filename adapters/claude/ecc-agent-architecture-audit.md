<!-- skill-id: ecc-agent-architecture-audit -->
<!-- source-path: ecc/agent-architecture-audit -->
<!-- source-file: C:/Users/MDES-DEV-NB/.claude/skills/ecc/agent-architecture-audit/SKILL.md -->
<!-- runtime: claude -->
