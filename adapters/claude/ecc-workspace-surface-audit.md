<!-- skill-id: ecc-workspace-surface-audit -->
<!-- source-path: ecc/workspace-surface-audit -->
<!-- source-file: C:/Users/MDES-DEV-NB/.claude/skills/ecc/workspace-surface-audit/SKILL.md -->
<!-- runtime: claude -->
