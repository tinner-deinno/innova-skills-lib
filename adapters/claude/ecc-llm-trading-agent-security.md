<!-- skill-id: ecc-llm-trading-agent-security -->
<!-- source-path: ecc/llm-trading-agent-security -->
<!-- source-file: C:/Users/MDES-DEV-NB/.claude/skills/ecc/llm-trading-agent-security/SKILL.md -->
<!-- runtime: claude -->
