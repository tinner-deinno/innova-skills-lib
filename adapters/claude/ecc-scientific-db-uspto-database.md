<!-- skill-id: ecc-scientific-db-uspto-database -->
<!-- source-path: ecc/scientific-db-uspto-database -->
<!-- source-file: C:/Users/MDES-DEV-NB/.claude/skills/ecc/scientific-db-uspto-database/SKILL.md -->
<!-- runtime: claude -->
