<!-- skill-id: gsd-plan-review-convergence -->
<!-- source-path: gsd-plan-review-convergence -->
<!-- source-file: C:/Users/MDES-DEV-NB/.claude/skills/gsd-plan-review-convergence/SKILL.md -->
<!-- runtime: claude -->
