<!-- skill-id: ecc-netmiko-ssh-automation -->
<!-- source-path: ecc/netmiko-ssh-automation -->
<!-- source-file: C:/Users/MDES-DEV-NB/.claude/skills/ecc/netmiko-ssh-automation/SKILL.md -->
<!-- runtime: claude -->
