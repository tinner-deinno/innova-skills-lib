<!-- skill-id: ecc-swift-protocol-di-testing -->
<!-- source-path: ecc/swift-protocol-di-testing -->
<!-- source-file: C:/Users/MDES-DEV-NB/.claude/skills/ecc/swift-protocol-di-testing/SKILL.md -->
<!-- runtime: claude -->
